...
<section class="engine"><a href="https://mobirise.info/m">free website design templates</a></section><section class="counters2 counters cid-rYz8nPfenH" id="counters2-3">
        ...
        <div class="media-container-row">
            <div class="media-block" style="width: 25%;">
                <h2 class="mbr-section-title pb-3 align-left mbr-fonts-style display-2">
                    User<br>DashBoard</h2>
                <h3 class="mbr-section-subtitle pb-5 align-left mbr-fonts-style display-5">Welcome To UserDashBoard</h3>
    ...
    <div class="container">
        <div class="media-container-row">
            <div class="title col-12 col-md-8">
                <h2 class="align-center pb-3 mbr-fonts-style display-2">My Details</h2>
                <h3 class="mbr-section-subtitle align-center mbr-light mbr-fonts-style display-5">Manage Your Info&nbsp;</h3>
...
<section class="features1 cid-rYzuOfMLoQ" id="features1-o">
    ...
    <div class="container">
        <div class="media-container-row">
            ...
            <div class="card p-3 co l-12 col-md-6">
                <div class="card-img pb-3">
                <a href='viewmydetails.php'><span class="mbr-iconfont mbri-italic"></span></a>
                </div>
                <div class="card-box" >
                    <h4 class="card-title py-3 mbr-fonts-style display-5">
                        View/Edit My Details</h4>
                    <p class="mbr-text mbr-fonts-style display-7">
                        View/Edit Your Details</p>
                </div>
            </div>
        ...
        <div class="row justify-content-center content-row">
            <div class="media-container-column title col-12 col-lg-7 col-md-6">
                <h3 class="mbr-section-subtitle align-left mbr-light pb-3 mbr-fonts-style display-5">
                    Contact Us We Are Here For You</h3>
...
<section class="mbr-section info1 cid-rYzxdAYqgT" id="info1-s">
  ...
  <div class="container container-table">
      <h2 class="mbr-section-title mbr-fonts-style align-center pb-3 display-2">Who Is Free To Join</h2>
      <h3 class="mbr-section-subtitle mbr-fonts-style align-center pb-5 mbr-light display-5">
            View Who Can Play With You&nbsp;</h3>
        ...
        <div class="media-container-row">
            <div class="title col-12 col-md-8">
                <h2 class="align-center pb-3 mbr-fonts-style display-2">
                    My Bookings</h2>
                <h3 class="mbr-section-subtitle align-center mbr-light mbr-fonts-style display-5">Manage Your Bookings</h3>
