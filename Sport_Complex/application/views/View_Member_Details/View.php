    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="title col-12 col-lg-8">
                <h2 class="mbr-section-title align-center pb-3 mbr-fonts-style display-5">Your Details</h2>
                ...
                <form action="update.php" method="POST" class="mbr-form form-with-styler">
                    ...
                    <div class="dragArea row">
                        <div class="col  form-group" data-for="name">
                            ...
                            <input type="text" name="name" data-form-field="Name" required="required" class="form-control display-7" value="<?php echo $_SESSION['231nic'] ?>" id="nic" readonly>
                        </div>
                    </div>
                     <div class="dragArea row">
                        <div class="col  form-group" data-for="name">
                            <label for="name-form1-5" class="form-control-label mbr-fonts-style display-7">User Name</label>
                            <input type="text" name="name" data-form-field="Name" required="required" class="form-control display-7" value="<?php echo $_SESSION['231uname'] ?>" id="uname" readonly>
                        </div>
                    </div>
                    <div class="dragArea row">
                        <div class="col  form-group" data-for="name">
                            <label for="name-form1-5" class="form-control-label mbr-fonts-style display-7">First Name</label>
                            <input type="text" name="name" data-form-field="Name" required="required" class="form-control display-7" value="<?php echo $_SESSION['231fname'] ?>" id="fname">
                        </div>
                    </div>
                    <div class="dragArea row">
                        <div class="col  form-group" data-for="name">
                            <label for="name-form1-5" class="form-control-label mbr-fonts-style display-7">Last Name</label>
                            <input type="text" name="name" data-form-field="Name" required="required" class="form-control display-7" value="<?php echo $_SESSION['231lname'] ?>" id="lname">
                        </div>
                    </div>
                    <div class="dragArea row">
                        <div class="col  form-group" data-for="name">
                            <label for="name-form1-5" class="form-control-label mbr-fonts-style display-7">Email</label>
                            <input type="text" name="name" data-form-field="Name" required="required" class="form-control display-7" value="<?php echo $_SESSION['231email'] ?>" id="email">
                        </div>
                    </div>
                    <div class="dragArea row">
                        <div class="col  form-group" data-for="name">
                            <label for="name-form1-5" class="form-control-label mbr-fonts-style display-7">Mobile No</label>
                            <input type="text" name="name" data-form-field="Name" required="required" class="form-control display-7" value="<?php echo $_SESSION['231mobile'] ?>" id="mobile">
                        </div>
                    </div>
                    <div class="dragArea row">
                        <div class="col  form-group" data-for="name">
                    ...
                    <div class="dragArea row">
                        <div class="col  form-group" data-for="name">
                            ...
                            <input type="text" name="name" data-form-field="Name" required="required" class="form-control display-7" value="<?php echo $_SESSION['231privilege'] ?>" id="privilege" readonly>
                        </div>
                    </div>
                    <div class="dragArea row">
                        <div class="col  form-group" data-for="name">
                            <label for="name-form1-5" class="form-control-label mbr-fonts-style display-7">Status</label>
                            <input type="text" name="name" data-form-field="Name" required="required" class="form-control display-7" value="<?php echo $_SESSION['231status'] ?>" id="status" readonly>
                        </div>
                    </div>
