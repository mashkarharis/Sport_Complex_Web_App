    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="title col-12 col-lg-8">
                <h2 class="mbr-section-title align-center pb-3 mbr-fonts-style display-5">Remove Sports</h2>
                ...
                <form action="remove.php" method="POST" class="mbr-form form-with-styler">
                    ...
                    <div class="dragArea row">
                        <div class="col  form-group" data-for="name">
                            ...
                            <input type="text" name="sname" id="sname" data-form-field="Name" required="required" class="form-control display-7" >
                        </div>
                    </div>
