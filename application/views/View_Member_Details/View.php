        ...
        <div class="row justify-content-center">
            <div class="media-container-column col-lg-8" data-form-type="formoid">
                ...
                <form action="update.php" method="POST" class="mbr-form form-with-styler">
                    ...
                    <div class="dragArea row">
                        <div class="col  form-group" data-for="name">
                            <input type="password" name="password" placeholder = "password" data-form-field="Name" required="required" class="form-control display-7"  value="<?php echo $_SESSION['231password'] ?>" id="password" hidden>
                        </div>
                    </div>
                    <div class="dragArea row">
                        <div class="col  form-group" data-for="name">
                            <input type="password" name="conpassword" placeholder= "conpassword" data-form-field="Name" required="required" class="form-control display-7" value="<?php echo $_SESSION['231password'] ?>" id="conpassword" hidden>
                        </div>
                    </div>
                    <div class="dragArea row">
                        <div class="col  form-group" data-for="name">
