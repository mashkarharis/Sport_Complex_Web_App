...
class SportFacadeImpl{
    ...
    public function fetchone($sname){
        try {
    ...
    public function update($name,$fee,$maxplay,$imgname,$mon_o,$mon_c,$tue_o,$tue_c,$wed_o,$wed_c,$thu_o,$thu_c,$fri_o,$fri_c,$sat_o,$sat_c,$sun_o,$sun_c){
        try {
    ...
    public function add($name,$fee,$maxplay,$imgname,$mon_o,$mon_c,$tue_o,$tue_c,$wed_o,$wed_c,$thu_o,$thu_c,$fri_o,$fri_c,$sat_o,$sat_c,$sun_o,$sun_c){
        try {
